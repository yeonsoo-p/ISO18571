...
[rating.py (line 88)](/home/user/workspace/ISO/ISO18571/python/iso18571/rating.py:88), [rating.py (line 175)](/home/user/workspace/ISO/ISO18571/python/iso18571/rating.py:175), [rating.py (line 189)](/home/user/workspace/ISO/ISO18571/python/iso18571/rating.py:189): ISO18571 stores live np.asarray views for later diagnostic properties while native scoring materializes values during construction. If the caller mutates the original arrays, scores stay old but shifted_* and corridor properties change. I reproduced Z == 1.0 while shifted_reference_values changed to mutated values. Copy the curves at construction or store native materialized diagnostic arrays, and return copies for view-like properties if immutability is intended.
