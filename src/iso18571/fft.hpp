...
struct util // hack to avoid duplicate symbols
{
    ...
    static void sanity_check (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out,
                              bool inplace) {
...
#define FFT_PARTSTEP3b(u1, u2, twr, twi)                        \
    ...
    template<bool fwd, typename T>
    void pass3 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch,
                const cmplx<T0>* FFT_RESTRICT wa) const {
        ...
        if (ido == 1)
            ...
            for (size_t k = 0; k < l1; ++k) {
                ...
                for (size_t i = 1; i < ido; ++i) {
                    FFT_PREP3(i)
                    FFT_PARTSTEP3b(1, 2, tw1r, tw1i)
                }
            }
    }

#undef FFT_PARTSTEP3b
#undef FFT_PARTSTEP3a
#undef FFT_PREP3
...
#define FFT_PARTSTEP5a(u1, u2, twar, twbr, twai, twbi) \
    {                                                  \
        T ca, cb;                                      \
...
#define FFT_PARTSTEP5b(u1, u2, twar, twbr, twai, twbi)          \
    {                                                           \
        T ca, cb, da, db;                                       \
        ca.r = t0.r + twar * t1.r + twbr * t2.r;                \
        ca.i = t0.i + twar * t1.i + twbr * t2.i;                \
    ...
    template<bool fwd, typename T>
    void pass5 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch,
                const cmplx<T0>* FFT_RESTRICT wa) const {
        ...
        if (ido == 1)
            for (size_t k = 0; k < l1; ++k) {
                FFT_PREP5(0)
                FFT_PARTSTEP5a(1, 4, tw1r, tw2r, +tw1i, +tw2i) FFT_PARTSTEP5a(2, 3, tw2r, tw1r, +tw2i, -tw1i)
            }
        else
            for (size_t k = 0; k < l1; ++k) {
                {
                ...
                for (size_t i = 1; i < ido; ++i) {
                    FFT_PREP5(i)
                    FFT_PARTSTEP5b(1, 4, tw1r, tw2r, +tw1i, +tw2i) FFT_PARTSTEP5b(2, 3, tw2r, tw1r, +tw2i, -tw1i)
                }
            }
    }

#undef FFT_PARTSTEP5b
#undef FFT_PARTSTEP5a
#undef FFT_PREP5

#define FFT_PREP7(idx)                            \
...
#define FFT_PARTSTEP7a0(u1, u2, x1, x2, x3, y1, y2, y3, out1, out2) \
    {                                                               \
        T ca, cb;                                                   \
...
#define FFT_PARTSTEP7a(u1, u2, x1, x2, x3, y1, y2, y3)                          \
    FFT_PARTSTEP7a0(u1, u2, x1, x2, x3, y1, y2, y3, CH(0, k, u1), CH(0, k, u2))
#define FFT_PARTSTEP7(u1, u2, x1, x2, x3, y1, y2, y3)                                                              \
    {                                                                                                              \
        T da, db;                                                                                                  \
        FFT_PARTSTEP7a0(u1, u2, x1, x2, x3, y1, y2, y3, da, db) special_mul<fwd>(da, WA(u1 - 1, i), CH(i, k, u1)); \
        special_mul<fwd>(db, WA(u2 - 1, i), CH(i, k, u2));                                                         \
    }

    template<bool fwd, typename T>
    void pass7 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch,
                const cmplx<T0>* FFT_RESTRICT wa) const {
        ...
        if (ido == 1)
            for (size_t k = 0; k < l1; ++k) {
                FFT_PREP7(0)
                FFT_PARTSTEP7a(1, 6, tw1r, tw2r, tw3r, +tw1i, +tw2i, +tw3i)
                    FFT_PARTSTEP7a(2, 5, tw2r, tw3r, tw1r, +tw2i, -tw3i, -tw1i)
                        FFT_PARTSTEP7a(3, 4, tw3r, tw1r, tw2r, +tw3i, -tw1i, +tw2i)
            }
        else
            for (size_t k = 0; k < l1; ++k) {
                {
                ...
                for (size_t i = 1; i < ido; ++i) {
                    FFT_PREP7(i)
                    FFT_PARTSTEP7(1, 6, tw1r, tw2r, tw3r, +tw1i, +tw2i, +tw3i)
                    FFT_PARTSTEP7(2, 5, tw2r, tw3r, tw1r, +tw2i, -tw3i, -tw1i)
                    FFT_PARTSTEP7(3, 4, tw3r, tw1r, tw2r, +tw3i, -tw1i, +tw2i)
                }
            }
    }

#undef FFT_PARTSTEP7
#undef FFT_PARTSTEP7a0
#undef FFT_PARTSTEP7a
#undef FFT_PREP7
...
#define FFT_PARTSTEP11a0(u1, u2, x1, x2, x3, x4, x5, y1, y2, y3, y4, y5, out1, out2) \
    {                                                                                \
...
#define FFT_PARTSTEP11a(u1, u2, x1, x2, x3, x4, x5, y1, y2, y3, y4, y5)                          \
    FFT_PARTSTEP11a0(u1, u2, x1, x2, x3, x4, x5, y1, y2, y3, y4, y5, CH(0, k, u1), CH(0, k, u2))
#define FFT_PARTSTEP11(u1, u2, x1, x2, x3, x4, x5, y1, y2, y3, y4, y5)           \
    {                                                                            \
        T da, db;                                                                \
        FFT_PARTSTEP11a0(u1, u2, x1, x2, x3, x4, x5, y1, y2, y3, y4, y5, da, db) \
            special_mul<fwd>(da, WA(u1 - 1, i), CH(i, k, u1));                   \
        special_mul<fwd>(db, WA(u2 - 1, i), CH(i, k, u2));                       \
    }

    template<bool fwd, typename T>
    void pass11 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch,
                 const cmplx<T0>* FFT_RESTRICT wa) const {
        ...
        if (ido == 1)
            for (size_t k = 0; k < l1; ++k) {
                FFT_PREP11(0)
                FFT_PARTSTEP11a(1, 10, tw1r, tw2r, tw3r, tw4r, tw5r, +tw1i, +tw2i, +tw3i, +tw4i, +tw5i)
                    FFT_PARTSTEP11a(2, 9, tw2r, tw4r, tw5r, tw3r, tw1r, +tw2i, +tw4i, -tw5i, -tw3i, -tw1i)
                        FFT_PARTSTEP11a(3, 8, tw3r, tw5r, tw2r, tw1r, tw4r, +tw3i, -tw5i, -tw2i, +tw1i, +tw4i)
                            FFT_PARTSTEP11a(4, 7, tw4r, tw3r, tw1r, tw5r, tw2r, +tw4i, -tw3i, +tw1i, +tw5i, -tw2i)
                                FFT_PARTSTEP11a(5, 6, tw5r, tw1r, tw4r, tw2r, tw3r, +tw5i, -tw1i, +tw4i, -tw2i, +tw3i)
            }
        else
            for (size_t k = 0; k < l1; ++k) {
                {
                    ...
                    FFT_PARTSTEP11a(1, 10, tw1r, tw2r, tw3r, tw4r, tw5r, +tw1i, +tw2i, +tw3i, +tw4i, +tw5i)
                        FFT_PARTSTEP11a(2, 9, tw2r, tw4r, tw5r, tw3r, tw1r, +tw2i, +tw4i, -tw5i, -tw3i, -tw1i)
                            FFT_PARTSTEP11a(3, 8, tw3r, tw5r, tw2r, tw1r, tw4r, +tw3i, -tw5i, -tw2i, +tw1i, +tw4i)
                                FFT_PARTSTEP11a(4, 7, tw4r, tw3r, tw1r, tw5r, tw2r, +tw4i, -tw3i, +tw1i, +tw5i, -tw2i)
                                    FFT_PARTSTEP11a(5, 6, tw5r, tw1r, tw4r, tw2r, tw3r, +tw5i, -tw1i, +tw4i, -tw2i,
                                                    +tw3i)
                }
                for (size_t i = 1; i < ido; ++i) {
                    FFT_PREP11(i)
                    FFT_PARTSTEP11(1, 10, tw1r, tw2r, tw3r, tw4r, tw5r, +tw1i, +tw2i, +tw3i, +tw4i, +tw5i)
                    FFT_PARTSTEP11(2, 9, tw2r, tw4r, tw5r, tw3r, tw1r, +tw2i, +tw4i, -tw5i, -tw3i, -tw1i)
                    FFT_PARTSTEP11(3, 8, tw3r, tw5r, tw2r, tw1r, tw4r, +tw3i, -tw5i, -tw2i, +tw1i, +tw4i)
                    FFT_PARTSTEP11(4, 7, tw4r, tw3r, tw1r, tw5r, tw2r, +tw4i, -tw3i, +tw1i, +tw5i, -tw2i)
                    FFT_PARTSTEP11(5, 6, tw5r, tw1r, tw4r, tw2r, tw3r, +tw5i, -tw1i, +tw4i, -tw2i, +tw3i)
                }
            }
    }

#undef FFT_PARTSTEP11
#undef FFT_PARTSTEP11a0
#undef FFT_PARTSTEP11a
#undef FFT_PREP11

    template<bool fwd, typename T>
    void passg (size_t ido, size_t ip, size_t l1, T* FFT_RESTRICT cc, T* FFT_RESTRICT ch,
                const cmplx<T0>* FFT_RESTRICT wa, const cmplx<T0>* FFT_RESTRICT csarr) const {
...
class rfftp {
  private:
    ...
    template<typename T>
    void radf2 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
...
// a2=a+b; b2=i*(b-a);
#define FFT_REARRANGE(rx, ix, ry, iy)                                \
    {                                                                \
    ...
    template<typename T>
    void radf3 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
    ...
    template<typename T>
    void radf4 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
        constexpr T0 hsqt2 = T0(0.707106781186547524400844362104849L);
    ...
    template<typename T>
    void radf5 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
        ...
        for (size_t k = 0; k < l1; ++k)
            for (size_t i = 2, ic = ido - 2; i < ido; i += 2, ic -= 2) {
                ...
                FFT_REARRANGE(dr2, di2, dr5, di5);
                FFT_REARRANGE(dr3, di3, dr4, di4);
...
#undef FFT_REARRANGE
    ...
    template<typename T>
    void radfg (size_t ido, size_t ip, size_t l1, T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa,
                const T0* FFT_RESTRICT csarr) const {
        const size_t cdim = ip;
        size_t       ipph = (ip + 1) / 2;
        size_t       idl1 = ido * l1;
    ...
    template<typename T>
    void radb2 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
        auto WA = [wa, ido] (size_t x, size_t i) { return wa[i + x * (ido - 1)]; };
        auto CC = [cc, ido] (size_t a, size_t b, size_t c) -> const T& { return cc[a + ido * (b + 2 * c)]; };
        auto CH = [ch, ido, l1] (size_t a, size_t b, size_t c) -> T& { return ch[a + ido * (b + l1 * c)]; };
    ...
    template<typename T>
    void radb3 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
        constexpr T0 taur = -0.5, taui = T0(0.8660254037844386467637231707529362L);
    ...
    template<typename T>
    void radb4 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
    ...
    template<typename T>
    void radb5 (size_t ido, size_t l1, const T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa) const {
        constexpr T0 tr11 = T0(0.3090169943749474241022934171828191L), ti11 = T0(0.9510565162951535721164393333793821L),
                     tr12 = T0(-0.8090169943749474241022934171828191L),
                     ti12 = T0(0.5877852522924731291687059546390728L);
    ...
    template<typename T>
    void radbg (size_t ido, size_t ip, size_t l1, T* FFT_RESTRICT cc, T* FFT_RESTRICT ch, const T0* FFT_RESTRICT wa,
                const T0* FFT_RESTRICT csarr) const {
        const size_t cdim = ip;
        size_t       ipph = (ip + 1) / 2;
        size_t       idl1 = ido * l1;
  ...
  public:
    rfftp (size_t length_): length(length_) {
        if (length == 0)
            throw std::runtime_error("zero-length FFT requested");
        if (length == 1)
            return;
...
class fftblue {
  ...
  public:
    fftblue (size_t length)
        : n(length), n2(util::good_size_cmplx(n * 2 - 1)), plan(n2), mem(n + n2 / 2 + 1), bk(mem.data()),
          bkf(mem.data() + n) {
        /* initialize b_k */
...
class fft_c {
  ...
  public:
    fft_c (size_t length): len(length) {
        if (length == 0)
            throw std::runtime_error("zero-length FFT requested");
...
class fft_r {
  ...
  public:
    fft_r (size_t length): len(length) {
        if (length == 0)
            throw std::runtime_error("zero-length FFT requested");
        size_t tmp = (length < 50) ? 0 : util::largest_prime_factor(length);
        if (tmp * tmp <= length) {
...
class T_dct1 {
  ...
  public:
    T_dct1 (size_t length): fftplan(2 * (length - 1)) {}
...
class T_dst1 {
  ...
  public:
    T_dst1 (size_t length): fftplan(2 * (length + 1)) {}
...
class T_dcst23 {
  ...
  public:
    T_dcst23 (size_t length): fftplan(length), twiddle(length) {
...
class T_dcst4 {
  private:
    size_t                     N;
    std::unique_ptr<fft_c<T0>> fft;
    std::unique_ptr<fft_r<T0>> rfft;
    arr<cmplx<T0>>             C2;

  public:
    T_dcst4 (size_t length)
        : N(length), fft((N & 1) ? nullptr : new fft_c<T0>(N / 2)), rfft((N & 1) ? new fft_r<T0>(N) : nullptr),
          C2((N & 1) ? 0 : N / 2) {
        if ((N & 1) == 0) {
...
class multi_iter {
  ...
  public:
    multi_iter (const arr_info& iarr_, const arr_info& oarr_, size_t idim_)
        : pos(iarr_.ndim(), 0), iarr(iarr_), oarr(oarr_), p_ii(0), str_i(iarr.stride(idim_)), p_oi(0),
          str_o(oarr.stride(idim_)), idim(idim_), rem(iarr.size() / iarr.shape(idim)) {}
...
void copy_input (const multi_iter<vlen>& it, const cndarr<cmplx<T>>& src, cmplx<vtype_t<T>>* FFT_RESTRICT dst) {
...
template<typename T, size_t vlen>
void copy_input (const multi_iter<vlen>& it, const cndarr<T>& src, vtype_t<T>* FFT_RESTRICT dst) {
    for (size_t i = 0; i < it.length_in(); ++i)
        for (size_t j = 0; j < vlen; ++j)
...
template<typename T, size_t vlen>
void copy_input (const multi_iter<vlen>& it, const cndarr<T>& src, T* FFT_RESTRICT dst) {
...
template<typename T, size_t vlen>
void copy_output (const multi_iter<vlen>& it, const cmplx<vtype_t<T>>* FFT_RESTRICT src, ndarr<cmplx<T>>& dst) {
...
template<typename T, size_t vlen>
void copy_output (const multi_iter<vlen>& it, const vtype_t<T>* FFT_RESTRICT src, ndarr<T>& dst) {
    for (size_t i = 0; i < it.length_out(); ++i)
        for (size_t j = 0; j < vlen; ++j)
...
template<typename T, size_t vlen>
void copy_output (const multi_iter<vlen>& it, const T* FFT_RESTRICT src, ndarr<T>& dst) {
...
void general_nd (const cndarr<T>& in, ndarr<T>& out, const shape_t& axes, T0 fct, const Exec& exec,
...
struct ExecC2C {
    ...
    void operator ()(const multi_iter<vlen>& it, const cndarr<cmplx<T0>>& in, ndarr<cmplx<T0>>& out, T* buf,
                     const fft_c<T0>& plan, T0 fct) const {
...
template<typename T, size_t vlen>
void copy_hartley (const multi_iter<vlen>& it, const vtype_t<T>* FFT_RESTRICT src, ndarr<T>& dst) {
    for (size_t j = 0; j < vlen; ++j)
...
template<typename T, size_t vlen>
void copy_hartley (const multi_iter<vlen>& it, const T* FFT_RESTRICT src, ndarr<T>& dst) {
    dst[it.oofs(0)] = src[0];
    size_t i = 1, i1 = 1, i2 = it.length_out() - 1;
    for (i = 1; i < it.length_out() - 1; i += 2, ++i1, --i2) {
...
struct ExecHartley {
    template<typename T0, typename T, size_t vlen>
    void operator ()(const multi_iter<vlen>& it, const cndarr<T0>& in, ndarr<T0>& out, T* buf, const fft_r<T0>& plan,
                     T0 fct) const {
        copy_input(it, in, buf);
...
struct ExecDcst {
    ...
    void operator ()(const multi_iter<vlen>& it, const cndarr<T0>& in, ndarr<T0>& out, T* buf, const Tplan& plan,
                     T0 fct) const {
        copy_input(it, in, buf);
...
template<typename T>
void general_r2c (const cndarr<T>& in, ndarr<cmplx<T>>& out, size_t axis, bool forward, T fct) {
    auto   plan = get_plan<fft_r<T>>(in.shape(axis));
...
template<typename T>
void general_c2r (const cndarr<cmplx<T>>& in, ndarr<T>& out, size_t axis, bool forward, T fct) {
    auto   plan = get_plan<fft_r<T>>(out.shape(axis));
...
template<typename T>
void c2c (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes,
          bool forward, const std::complex<T>* data_in, std::complex<T>* data_out, T fct) {
    if (util::prod(shape) == 0)
        return;
    util::sanity_check(shape, stride_in, stride_out, data_in == data_out, axes);
    cndarr<cmplx<T>> ain(data_in, shape, stride_in);
    ndarr<cmplx<T>>  aout(data_out, shape, stride_out);
    general_nd<fft_c<T>>(ain, aout, axes, fct, ExecC2C {forward});
}
...
void dct (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes, int type,
    ...
    if (type == 1)
        general_nd<T_dct1<T>>(ain, aout, axes, fct, exec);
    else if (type == 4)
        general_nd<T_dcst4<T>>(ain, aout, axes, fct, exec);
    else
        general_nd<T_dcst23<T>>(ain, aout, axes, fct, exec);
}
...
void dst (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes, int type,
    ...
    if (type == 1)
        general_nd<T_dst1<T>>(ain, aout, axes, fct, exec);
    else if (type == 4)
        general_nd<T_dcst4<T>>(ain, aout, axes, fct, exec);
    else
        general_nd<T_dcst23<T>>(ain, aout, axes, fct, exec);
...
void r2c (const shape_t& shape_in, const stride_t& stride_in, const stride_t& stride_out, size_t axis, bool forward,
    ...
    general_r2c(ain, aout, axis, forward, fct);
}

template<typename T>
void r2c (const shape_t& shape_in, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes,
          bool forward, const T* data_in, std::complex<T>* data_out, T fct) {
    if (util::prod(shape_in) == 0)
        return;
    util::sanity_check(shape_in, stride_in, stride_out, false, axes);
    r2c(shape_in, stride_in, stride_out, axes.back(), forward, data_in, data_out, fct);
    if (axes.size() == 1)
        return;
    ...
    c2c(shape_out, stride_out, stride_out, newaxes, forward, data_out, data_out, T(1));
}
...
void c2r (const shape_t& shape_out, const stride_t& stride_in, const stride_t& stride_out, size_t axis, bool forward,
    ...
    general_c2r(ain, aout, axis, forward, fct);
}

template<typename T>
void c2r (const shape_t& shape_out, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes,
    ...
    auto                 newaxes = shape_t {axes.begin(), --axes.end()};
    c2c(shape_in, stride_in, stride_inter, newaxes, forward, data_in, tmp.data(), T(1));
...
void r2r_fftpack (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out, const shape_t& axes,
    ...
    cndarr<T> ain(data_in, shape, stride_in);
    ndarr<T>  aout(data_out, shape, stride_out);
    general_nd<fft_r<T>>(ain, aout, axes, fct, ExecR2R {real2hermitian, forward});
}

template<typename T>
void r2r_separable_hartley (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out,
    ...
    cndarr<T> ain(data_in, shape, stride_in);
    ndarr<T>  aout(data_out, shape, stride_out);
    general_nd<fft_r<T>>(ain, aout, axes, fct, ExecHartley {}, false);
}

template<typename T>
void r2r_genuine_hartley (const shape_t& shape, const stride_t& stride_in, const stride_t& stride_out,
                          const shape_t& axes, const T* data_in, T* data_out, T fct) {
    if (util::prod(shape) == 0)
        return;
    if (axes.size() == 1)
